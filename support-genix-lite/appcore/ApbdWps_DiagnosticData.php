 ...
 * Class.
 */
if (! class_exists('ApbdWps_DiagnosticData')) {
    class ApbdWps_DiagnosticData
    {
        ...
        private function __construct($version = '')
        {
            ...
            if (get_option('support_genix_lite_diagnostic_data_agreed') === 'yes' || get_option('support_genix_lite_diagnostic_data_notice') === 'no') {
                return;
            }
        ...
        public function should_show_notice()
        {
            ...
            foreach ($sibling_plugins as $plugin_slug => $options) {
                if (get_option($options['agreed']) === 'yes') {
                    update_option('support_genix_lite_diagnostic_data_agreed', 'yes');
                    update_option('support_genix_lite_diagnostic_data_notice', 'no');
                    return false;
                }
            }
...
?>
            <div class="support-genix-lite-diagnostic-data-style">
                <style>
                    ...
                    .support-genix-lite-diagnostic-data-list-toogle {
                        cursor: pointer;
                        color: #2271b1;
                        ...
                        $(".support-genix-lite-diagnostic-data-button").on("click", function(e) {
                            ...
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    agreed: agreed,
                                    _ajax_nonce: '<?php echo esc_attr(wp_create_nonce('ajax-nonce')); ?>'
                                },
                                beforeSend: function() {
...
<?php
        ...
        {
            /* translators: %1$s: Project name, %2$s: Opening strong tag, %3$s: Closing strong tag */
    ...
    ApbdWps_DiagnosticData::get_instance($apbdWpSupportLiteVersion);
}
