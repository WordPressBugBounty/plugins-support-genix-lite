...
namespace ApbdWps\Vendor\Symfony\Component\CssSelector\XPath;

use ApbdWps\Vendor\Symfony\Component\CssSelector\Exception\ExpressionErrorException;
use ApbdWps\Vendor\Symfony\Component\CssSelector\Node\FunctionNode;
use ApbdWps\Vendor\Symfony\Component\CssSelector\Node\NodeInterface;
use ApbdWps\Vendor\Symfony\Component\CssSelector\Node\SelectorNode;
use ApbdWps\Vendor\Symfony\Component\CssSelector\Parser\Parser;
use ApbdWps\Vendor\Symfony\Component\CssSelector\Parser\ParserInterface;
...
class Translator implements TranslatorInterface
{
    ...
    public function addAttributeMatching(XPathExpr $xpath, string $operator, string $attribute, ?string $value): XPathExpr
    {
        if (!isset($this->attributeMatchingTranslators[$operator])) {
            throw new ExpressionErrorException(sprintf('ApbdWps_Vendor_Attribute matcher operator "%s" not supported.', $operator));
        }
