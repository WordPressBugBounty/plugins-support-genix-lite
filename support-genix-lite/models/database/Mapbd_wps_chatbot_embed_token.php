...
class Mapbd_wps_chatbot_embed_token extends ApbdWpsModel
{
    ...
    function SetValidation()
    {
        $this->validations = array(
            ...
            "allowed_domains" => array("Text" => "Allowed Domains", "Rule" => "max_length[5242880]"),
            "feature_opts" => array("Text" => "Feature Options", "Rule" => "max_length[5242880]"),
            "allowed_spaces" => array("Text" => "Allowed Spaces", "Rule" => "max_length[5242880]"),
            "allowed_categories" => array("Text" => "Allowed Categories", "Rule" => "max_length[5242880]"),
